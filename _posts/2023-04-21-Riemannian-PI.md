...
<p>where $\mathbf{\lambda}$ is the difference of the principal curvatures $\lambda_{1}-\lambda_{2}$. Because we consider $R\geq 0$, and $\int_{S}K\leq 4$
