---
title: Poincare conjecture and the h-cobordism theorem
math: true
date: 2023-04-16 08:26:14 +/-0800
categories: [Differential Geometry, Topology]
tags: [math.DG, math.AT]     # TAG names should always be lowercase
---
The way to define an h-cobordism is as follows: if the inclusion maps $\iota _{0}$ and $\iota _{1}$ corresponding to a cobordism $M$ are homotopy equivalences, then $M$ is said to be an h-cobordism. That is, if the inclusion maps $\iota _{0}:N_{0}\hookrightarrow M$ and $\iota _{1}: N_{1}\hookrightarrow M$ are homotopy equivalences, then we say that the cobordism $M$ is an h-cobordism. The h-cobordism theorem is as follows:
